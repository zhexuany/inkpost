...
const sanitizeSchema = {
  ...
  attributes: {
    ...
    path: ['d', 'fill', 'stroke', 'stroke-width', 'strokeWidth', 'stroke-linecap', 'strokeLinecap', 'stroke-linejoin', 'strokeLinejoin'],
    g: ['fill', 'stroke', 'stroke-width', 'strokeWidth', 'transform'],
    use: ['href', 'xlink:href', 'xlinkHref'],
    line: ['x1', 'y1', 'x2', 'y2', 'stroke', 'stroke-width', 'strokeWidth'],
    rect: ['x', 'y', 'width', 'height', 'fill', 'stroke'],
    circle: ['cx', 'cy', 'r', 'fill', 'stroke'],
    ellipse: ['cx', 'cy', 'rx', 'ry', 'fill', 'stroke'],
    polygon: ['points', 'fill', 'stroke'],
    polyline: ['points', 'fill', 'stroke'],
    text: ['x', 'y', 'font-size', 'fontSize', 'font-family', 'fontFamily', 'fill', 'text-anchor', 'textAnchor', 'dominant-baseline', 'dominantBaseline'],
    tspan: ['x', 'y', 'font-size', 'fontSize', 'font-family', 'fontFamily', 'fill'],
  },
};
